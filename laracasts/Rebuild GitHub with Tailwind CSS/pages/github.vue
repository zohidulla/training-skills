<template>
  <div class="text-gray-900 text-sm">
    <nav class="bg-gray-900 text-white px-4 py-3 flex items-center justify-between">
      ...
      <div class="flex items-center space-x-4 text-white">
        ...
        <a href="#" class="flex items-center hover:text-gray-400">
          <svg class="w-4" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"
            stroke="currentColor">
        ...
        <a href="#" class="flex items-center hover:text-gray-400">
          <img src="https://avatars0.githubusercontent.com/u/4316355?s=60&v=4" class="w-5 h-5 rounded-full" alt="avatar">
          <svg class="w-3 ml-1" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            viewBox="0 0 24 24" stroke="currentColor">
            <path d="M19 9l-7 7-7-7"></path>
          </svg>
    ...
    <div class="repo-stats flex flex-col lg:flex-row items-center justify-between px-8 py-4">
      ...
      <div class="flex space-x-2 mt-4 lg:mt-0">
        <div class="flex text-xs">
          <button
            class="border border-gray-400 rounded rounded-r-none px-3 py-1 hover:bg-gray-200 flex items-center space-x-1">
          ...
          <a href="#"
            class="border border-gray-400 rounded rounded-l-none border-l-0 font-semibold hover:text-blue-600 px-3 py-1">430</a>
        </div>
        <div class="flex text-xs">
          <button
            class="border border-gray-400 rounded rounded-r-none px-3 py-1 hover:bg-gray-200 flex items-center space-x-1">
            <svg class="fill-current text-gray-600 w-4" viewBox="0 0 16 16" version="1.1" width="16" aria-hidden="true">
              <path fill-rule="evenodd"
          ...
          <a href="#"
            class="border border-gray-400 border-l-0 rounded rounded-l-none font-semibold px-3 py-1 hover:text-blue-600">25.3k</a>
        </div>
        <div class="flex text-xs">
          <button
            class="border border-gray-400 rounded rounded-r-none px-3 py-1 hover:bg-gray-200 flex items-center space-x-1">
            <svg class="fill-current text-gray-600 w-4" viewBox="0 0 16 16" version="1.1" width="16" height="16"
              aria-hidden="true">
              <path fill-rule="evenodd"
          ...
          <a href="#"
            class="border border-gray-400 border-l-0 rounded rounded-l-none font-semibold px-3 py-1 hover:text-blue-600">1.2k</a>
        </div>
      </div>
    </div> <!-- end repo-stats -->
    ...
    <ul class="repo-nav border-b border-gray-400 flex items-center px-8 mt-4">
      <li class="font-semibold">
        <a href="#" class="flex items-center border-b-2 border-red-500 px-4 pb-3">
          <svg class="w-4 fill-current" classes="UnderlineNav-octicon" display="none inline" viewBox="0 0 16 16"
    ...
    <div class="container mx-auto my-8 px-4 flex flex-col lg:flex-row">
      <div class="file-explorer-container w-full lg:w-3/4 lg:mr-8">
        <div class="branch-navigation flex items-center justify-between">
          <div class="flex items-center space-x-3">
            <button class="border border-gray-400 rounded-md px-4 py-1 hover:bg-gray-200 flex items-center space-x-2">
              <svg class="fill-current text-gray-600 w-4" text="gray" viewBox="0 0 16 16" version="1.1" width="16"
                aria-hidden="true">
                <path fill-rule="evenodd"
            ...
            <a href="#" class="hidden lg:flex items-center space-x-2 py-1 group">
              <svg class="fill-current text-gray-600 group-hover:text-blue-600 w-4" text="gray" viewBox="0 0 16 16"
                version="1.1" width="16" aria-hidden="true">
                <path fill-rule="evenodd"
                  d="M11.75 2.5a.75.75 0 100 1.5.75.75 0 000-1.5zm-2.25.75a2.25 2.25 0 113 2.122V6A2.5 2.5 0 0110 8.5H6a1 1 0 00-1 1v1.128a2.251 2.251 0 11-1.5 0V5.372a2.25 2.25 0 111.5 0v1.836A2.492 2.492 0 016 7h4a1 1 0 001-1v-.628A2.25 2.25 0 019.5 3.25zM4.25 12a.75.75 0 100 1.5.75.75 0 000-1.5zM3.5 3.25a.75.75 0 111.5 0 .75.75 0 01-1.5 0z">
                </path>
          ...
          <div class="hidden lg:flex items-center space-x-2">
            ...
            <button
              ...
              <svg class="w-4 fill-current text-gray-200" viewBox="0 0 16 16" aria-hidden="true">
                <path fill-rule="evenodd"
        ...
        <div
          class="commits-container bg-blue-100 rounded-md rounded-b-none border border-blue-200 border-b-0 flex items-center justify-between px-4 py-4 mt-5">
          <div class="flex items-center space-x-2">
            <a href="#"><img
                src="https://avatars2.githubusercontent.com/u/4323180?s=60&u=4962a4441fae9fba5f0f86456c6c506a21ffca4f&v=4"
                alt="avatar" class="w-6 h-6 rounded-full"></a>
            <a href="#" class="font-semibold hover:underline">adamwathan</a>
            <a href="#" class="hover:underline hover:text-blue-600">1.5.1</a>
          </div>
          <div class="flex items-end">
            <a href="#">
              <svg class="w-4 fill-current text-green-500" aria-label="3 / 3 checks OK" viewBox="0 0 16 16" role="img">
                <path fill-rule="evenodd"
            ...
            <a href="#"
              class="font-mono text-xs text-gray-600 hover:underline hover:text-blue-500 ml-2 hidden lg:block">da070bd</a>
        ...
        <div
          ...
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            <div class="w-4/12 flex items-center">
              <svg class="w-4 fill-current text-blue-400" color="blue-3" aria-label="Directory" viewBox="0 0 16 16"
                role="img">
                <path fill-rule="evenodd"
            ...
            <div class="w-6/12 truncate hidden lg:block"><a href="#" class="hover:underline hover:text-blue-600">Update
                issues template</a></div>
          ...
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            ...
            <div class="w-6/12 truncate hidden lg:block"><a href="#" class="hover:underline hover:text-blue-600">Remove
                stale test</a></div>
          ...
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            ...
            <div class="w-6/12 truncate hidden lg:block"><a href="#" class="hover:underline hover:text-blue-600">Add empty
                .npmignore so dist files are distributed with releases</a></div>
          ...
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            ...
            <div class="w-6/12 truncate hidden lg:block"><a href="#" class="hover:underline hover:text-blue-600">Use
                `process.env.JEST_WORKER_ID`</a></div>
          ...
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            ...
            <div class="w-6/12 truncate hidden lg:block"><a href="#" class="hover:underline hover:text-blue-600">Prevent
                source maps from being generated</a></div>
          ...
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            ...
            <div class="w-6/12 truncate hidden lg:block"><a href="#" class="hover:underline hover:text-blue-600">Only wrap
                with variants if rules don't already contain any variants</a></div>
            <div class="w-4/12 lg:w-2/12 text-right">4 days ago</div>
          </div>
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            <div class="w-4/12 flex items-center">
            ...
            <div class="w-6/12 truncate hidden lg:block"><a href="#" class="hover:underline hover:text-blue-600">Generate
                responsive variants for container by default</a></div>
            <div class="w-4/12 lg:w-2/12 text-right">4 days ago</div>
          </div>
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            <div class="w-4/12 flex items-center">
              <svg class="w-4 fill-current text-gray-600" color="gray-light" aria-label="File" viewBox="0 0 16 16"
                role="img">
                <path fill-rule="evenodd"
            ...
            <div class="w-6/12 truncate hidden lg:block"><a href="#" class="hover:underline hover:text-blue-600">Convert
                new stuff to use ES6 modules</a></div>
            <div class="w-4/12 lg:w-2/12 text-right">3 years ago</div>
          </div>
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            <div class="w-4/12 flex items-center">
            ...
            <div class="w-6/12 truncate hidden lg:block"><a href="#" class="hover:underline hover:text-blue-600">Updated
                CLI init commend</a></div>
          ...
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            ...
            <div class="w-6/12 truncate hidden lg:block"><a href="#" class="hover:underline hover:text-blue-600">Disable
                lint rule for TODO comments</a></div>
          ...
          <div class="w-6/12 truncate hidden lg:block"><a href="#"
              class="hover:underline hover:text-blue-600 truncate hidden lg:block">Add new `plugin` and
              `plugin.withOptions` functions for creating plugins</a></div>
        ...
        <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
          ...
          <div class="w-6/12 truncate hidden lg:block"><a href="#" class="hover:underline hover:text-blue-600">Add alt
              attribute to logo</a></div>
        ...
        <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
          ...
          <div class="w-6/12 truncate hidden lg:block"><a href="#" class="hover:underline hover:text-blue-600">Undo
              accidental changes to CDN build process</a></div>
          <div class="w-4/12 lg:w-2/12 text-right">7 months ago</div>
        </div>
        <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
          <div class="w-4/12 flex items-center">
          ...
          <div class="w-6/12 truncate hidden lg:block"><a href="#" class="hover:underline hover:text-blue-600">Move CSS
              files to root for easier imports</a></div>
    ...
    <div class="sidebar w-full lg:w-1/4">
      <div class="about mt-4 lg:mt-0">
        ...
        <div class="flex items-center space-x-2 mt-4">
          <svg class="w-4 fill-current" mr="2" classes="flex-shrink-0" viewBox="0 0 16 16" aria-hidden="true">
            <path fill-rule="evenodd"
        ...
        <div class="tags text-xs font-semibold flex items-center flex-wrap mt-2">
          <a href="#"
            class="bg-blue-100 hover:bg-blue-200 text-blue-600 rounded-full px-2 py-1 mt-2 mr-2">tailwindcss</a>
          <a href="#" class="bg-blue-100 hover:bg-blue-200 text-blue-600 rounded-full px-2 py-1 mt-2 mr-2">css</a>
          <a href="#"
            class="bg-blue-100 hover:bg-blue-200 text-blue-600 rounded-full px-2 py-1 mt-2 mr-2">css-framework</a>
          <a href="#" class="bg-blue-100 hover:bg-blue-200 text-blue-600 rounded-full px-2 py-1 mt-2 mr-2">postcss</a>
          <a href="#"
            class="bg-blue-100 hover:bg-blue-200 text-blue-600 rounded-full px-2 py-1 mt-2 mr-2">functional-css</a>
          <a href="#"
            class="bg-blue-100 hover:bg-blue-200 text-blue-600 rounded-full px-2 py-1 mt-2 mr-2">utility-classes</a>
          <a href="#"
            class="bg-blue-100 hover:bg-blue-200 text-blue-600 rounded-full px-2 py-1 mt-2 mr-2">responsive</a>
        </div>

        <a href="#" class="flex items-center space-x-2 mt-4 group">
          <svg class="w-4 fill-current text-gray-600 group-hover:text-blue-600" mr="2" viewBox="0 0 16 16"
            aria-hidden="true">
            <path fill-rule="evenodd"
      ...
      <div class="releases border-t border-gray-400 mt-6 pt-6">
        ...
        <a href="#" class="flex items-start mt-4 group">
          <svg class="fill-current mt-1 w-4 text-green-500 group-hover:text-blue-500" mt="1" classes="flex-shrink-0"
            color="green" viewBox="0 0 16 16" aria-hidden="true">
            <path fill-rule="evenodd"
              d="M2.5 7.775V2.75a.25.25 0 01.25-.25h5.025a.25.25 0 01.177.073l6.25 6.25a.25.25 0 010 .354l-5.025 5.025a.25.25 0 01-.354 0l-6.25-6.25a.25.25 0 01-.073-.177zm-1.5 0V2.75C1 1.784 1.784 1 2.75 1h5.025c.464 0 .91.184 1.238.513l6.25 6.25a1.75 1.75 0 010 2.474l-5.026 5.026a1.75 1.75 0 01-2.474 0l-6.25-6.25A1.75 1.75 0 011 7.775zM6 5a1 1 0 100 2 1 1 0 000-2z">
            </path>
          </svg>
          <span class="ml-2">
            ...
            <span
              class="ml-1 text-xs border border-green-500 text-green-600 rounded-full font-semibold inline-block px-2">Latest</span>
        ...
        <div class="mt-4">
          <a href="#" class="flex items-center -space-x-2">
            <img src="https://s3.amazonaws.com/uifaces/faces/twitter/antonyzotov/128.jpg"
              class="w-8 border-2 border-white rounded-full" alt="avatar">
            <img src="https://s3.amazonaws.com/uifaces/faces/twitter/pcridesagain/128.jpg"
              class="w-8 rounded-full border-2 border-white" alt="avatar">
            <img src="https://s3.amazonaws.com/uifaces/faces/twitter/davidhemphill/128.jpg"
              class="w-8 rounded-full border-2 border-white" alt="avatar">
            <img src="https://s3.amazonaws.com/uifaces/faces/twitter/abdots/128.jpg"
              class="w-8 rounded-full border-2 border-white" alt="avatar">
            <img src="https://s3.amazonaws.com/uifaces/faces/twitter/kerem/128.jpg"
              class="w-8 rounded-full border-2 border-white" alt="avatar">
            <img src="https://s3.amazonaws.com/uifaces/faces/twitter/runningskull/128.jpg"
              class="w-8 rounded-full border-2 border-white" alt="avatar">
            <img src="https://s3.amazonaws.com/uifaces/faces/twitter/gusoto/128.jpg"
              class="w-8 rounded-full border-2 border-white" alt="avatar">
            <img src="https://s3.amazonaws.com/uifaces/faces/twitter/rodnylobos/128.jpg"
              class="w-8 rounded-full border-2 border-white" alt="avatar">
      ...
      <div class="contributors border-t border-gray-400 mt-6 pt-6">
        ...
        <div class="flex items-center flex-wrap mt-2">
          <a href="#"><img src="https://s3.amazonaws.com/uifaces/faces/twitter/vitorleal/128.jpg" alt="avatar"
              class="w-8 rounded-full mr-2 mt-2"></a>
          <a href="#"><img src="https://s3.amazonaws.com/uifaces/faces/twitter/byryan/128.jpg" alt="avatar"
              class="w-8 rounded-full mr-2 mt-2"></a>
          <a href="#"><img src="https://s3.amazonaws.com/uifaces/faces/twitter/juamperro/128.jpg" alt="avatar"
              class="w-8 rounded-full mr-2 mt-2"></a>
          <a href="#"><img src="https://s3.amazonaws.com/uifaces/faces/twitter/herkulano/128.jpg" alt="avatar"
              class="w-8 rounded-full mr-2 mt-2"></a>
          <a href="#"><img src="https://s3.amazonaws.com/uifaces/faces/twitter/jlsolerdeltoro/128.jpg" alt="avatar"
              class="w-8 rounded-full mr-2 mt-2"></a>
          <a href="#"><img src="https://s3.amazonaws.com/uifaces/faces/twitter/kostaspt/128.jpg" alt="avatar"
              class="w-8 rounded-full mr-2 mt-2"></a>
          <a href="#"><img src="https://s3.amazonaws.com/uifaces/faces/twitter/trubeatto/128.jpg" alt="avatar"
              class="w-8 rounded-full mr-2 mt-2"></a>
          <a href="#"><img src="https://s3.amazonaws.com/uifaces/faces/twitter/stan/128.jpg" alt="avatar"
              class="w-8 rounded-full mr-2 mt-2"></a>
          <a href="#"><img src="https://s3.amazonaws.com/uifaces/faces/twitter/sandywoodruff/128.jpg" alt="avatar"
              class="w-8 rounded-full mr-2 mt-2"></a>
          <a href="#"><img src="https://s3.amazonaws.com/uifaces/faces/twitter/chacky14/128.jpg" alt="avatar"
              class="w-8 rounded-full mr-2 mt-2"></a>
        </div>
  ...
  <footer
    ...
    <div class="mx-16 hidden lg:block">
      <a href="#">
        <svg class="w-6 fill-current text-gray-400 hover:text-gray-600" viewBox="0 0 16 16" aria-hidden="true">
          <path fill-rule="evenodd"
            d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0016 8c0-4.42-3.58-8-8-8z">
          </path>
        </svg>
